...
class IsCompany(permissions.BasePermission):
    def has_permission(self, request, view):
        ...
        return bool(request.user and request.user.is_authenticated and request.user.is_email_varified and request.user.is_admin_aproved  and request.user.user_type == "company")
